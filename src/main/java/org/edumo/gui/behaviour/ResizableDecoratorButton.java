...
public class ResizableDecoratorButton extends AbstractGUIModifier implements HIDEventListener {
	...
	public ResizableDecoratorButton(int strokeColor) {
	...
	public String drawUndecorated(PGraphics canvas) {
		...
		DraggableDecorator c = (DraggableDecorator) component;
